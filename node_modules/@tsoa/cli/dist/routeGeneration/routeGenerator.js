            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [4 /*yield*/, fs_1.fsWriteFile(fileName, content)];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            controllers: this.metadata.controllers.map(function (controller) {
                ...
                return {
                    actions: controller.methods.map(function (method) {
                        ...
                        var uploadFileParameter = method.parameters.find(function (parameter) { return parameter.type.dataType === 'file'; });
                        var uploadFilesParameter = method.parameters.find(function (parameter) { return parameter.type.dataType === 'array' && parameter.type.elementType.dataType === 'file'; });
                        return {
