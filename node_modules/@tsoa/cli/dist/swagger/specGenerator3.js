...
var SpecGenerator3 = /** @class */ (function (_super) {
    ...
    SpecGenerator3.prototype.getSwaggerTypeForEnumType = function (enumType) {
        ...
        if (types.size === 1) {
            var type_1 = types.values().next().value;
            var nullable = enumType.enums.includes(null) ? true : false;
            return { type: type_1, enum: enumType.enums.map(function (member) { return swaggerUtils_1.getValue(type_1, member); }), nullable: nullable };
        }
        else {
