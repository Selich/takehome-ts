...
var swaggerUtils_1 = require("./../utils/swaggerUtils");
...
var SpecGenerator2 = /** @class */ (function (_super) {
    ...
    SpecGenerator2.prototype.buildOperation = function (controllerName, method) {
        ...
        method.responses.forEach(function (res) {
            ...
            if (res.examples && res.examples[0]) {
                if ((((_a = res.exampleLabels) === null || _a === void 0 ? void 0 : _a.filter(function (e) { return e; }).length) || 0) > 0) {
    ...
    SpecGenerator2.prototype.getSwaggerTypeForEnumType = function (enumType) {
        ...
        return _a = { type: type, enum: enumType.enums.map(function (member) { return swaggerUtils_1.getValue(type, member); }) }, _a['x-nullable'] = nullable, _a;
    };
