...
var TypeResolver = /** @class */ (function () {
    ...
    TypeResolver.prototype.getEnumerateType = function (typeName) {
        ...
        var enums = enumDeclaration.members.map(function (e) { return _this.current.typeChecker.getConstantValue(e); }).filter(isNotUndefined);
    ...
    TypeResolver.prototype.getNodeExample = function (node) {
        ...
        return decoratorUtils_1.getNodeFirstDecoratorValue(node, this.current.typeChecker, function (dec) { return dec.text === 'Example'; });
    };
